...
const emptyForm = { email: "", password: "", role: "sub", permissions: [] };
...
const Admins = () => {
  ...
  const [edit, setEdit] = useState({ email: "", role: "sub", permissions: [], newPassword: "" });
          ...
          <div className="grid gap-5 sm:grid-cols-2">
            <div>
              ...
              <input
                ...
                placeholder="new.admin@betchokkor.com"
                className="ad-input"
                required
              />
            </div>
