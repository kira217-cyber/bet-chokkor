    ...
    <div className="mx-auto max-w-[1100px]">
      <div className="mb-6 flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-[14px] text-[var(--text-muted)]">All text & images of the affiliate landing page. Empty falls back to defaults. Colors: “Affiliate Home Theme”.</p>
        </div>
