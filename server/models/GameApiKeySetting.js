...
/**
 * white-label master এর API key।
 *
 * এই কী দিয়েই সার্ভার master থেকে ক্যাটাগরি, প্রোভাইডার, গেম, hot ও
 * popular গেম আনে। কী কখনো ব্রাউজারে যায় না — ক্লায়েন্ট শুধু আমাদের
